...
exports.configureGoogleStrategy = function () {
    passport.use(new GoogleStrategy.OAuth2Strategy({
        clientID: environment_1.devConfig.google.clientId,
        clientSecret: environment_1.devConfig.google.clientSecret,
        callbackURL: environment_1.devConfig.google.callbackURL
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_model_1["default"].findOne({ 'google.id': profile.id })];
                case 1:
                    user = _a.sent();
